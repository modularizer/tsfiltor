...
const user1 = users[0];
const isJohn = (0, src_1.evaluateCondition)(user1, (0, src_1.eq)('name', 'John Doe'));
console.log(`   Is user John Doe? ${isJohn}`); // true
// Example 2: Comparison operators
console.log('\n2. Comparison Operators:');
const adults = (0, src_1.filterEntities)(users, (0, src_1.gt)('age', 18));
console.log(`   Adults (age > 18): ${adults.length} users`);
adults.forEach(u => console.log(`   - ${u.name} (age ${u.age})`));
// Example 3: String operations
console.log('\n3. String Operations:');
const exampleEmails = (0, src_1.filterEntities)(users, (0, src_1.contains)('email', 'example'));
...
console.log('\n4. Regex Matching:');
const validEmails = (0, src_1.filterEntities)(users, (0, src_1.matches)('email', /^[\w.-]+@example\.com$/));
console.log(`   Valid example.com emails: ${validEmails.length}`);
// Example 5: AND conditions
console.log('\n5. AND Conditions:');
const activeAdults = (0, src_1.filterEntities)(users, (0, src_1.and)((0, src_1.eq)('status', 'active'), (0, src_1.gt)('age', 20)));
...
console.log('\n6. OR Conditions:');
const activeOrPending = (0, src_1.filterEntities)(users, (0, src_1.or)((0, src_1.eq)('status', 'active'), (0, src_1.eq)('status', 'pending')));
console.log(`   Active or pending: ${activeOrPending.length}`);
// Example 7: Complex nested conditions
console.log('\n7. Complex Nested Conditions:');
const complexFilter = (0, src_1.and)((0, src_1.or)((0, src_1.eq)('status', 'active'), (0, src_1.eq)('status', 'pending')), (0, src_1.gt)('age', 20), (0, src_1.contains)('email', 'example'));
const complexResults = (0, src_1.filterEntities)(users, complexFilter);
console.log(`   Complex filter results: ${complexResults.length}`);
// Example 8: Find first match
console.log('\n8. Find First Match:');
const firstVip = (0, src_1.findFirst)(users, (0, src_1.contains)('tags', 'vip'));
if (firstVip) {
    console.log(`   First VIP user: ${firstVip.name}`);
}
// Example 9: Plain object filter (matchesAll)
console.log('\n9. Plain Object Filter:');
const exactMatch = (0, src_1.filterEntities)(users, { name: 'John Doe', status: 'active' });
console.log(`   Exact match: ${exactMatch.length} user(s)`);
// Example 10: Array filter (AND logic)
console.log('\n10. Array Filter (AND logic):');
const arrayFilter = [
    (0, src_1.eq)('status', 'active'),
    (0, src_1.gt)('age', 25)
];
const arrayResults = (0, src_1.filterEntities)(users, arrayFilter);
